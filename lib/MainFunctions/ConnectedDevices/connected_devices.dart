...
import 'package:smart_cb_1/MainFunctions/ConnectedDevices/admin_list.dart';
import 'package:smart_cb_1/MainFunctions/ConnectedDevices/staff_list.dart';
...
class _ConnectedDevicesState extends State<ConnectedDevices> {
  ...
  // Switch Changed
  void switchChanged(bool? value, int index, String role) {
    setState(() {
      switch (role) {
        case 'owner':
          ownerList[index][1] = !ownerList[index][1];
          break;
        case 'admin':
          adminList[index][1] = !adminList[index][1];
          break;
        case 'staff':
          staffList[index][1] = !staffList[index][1];
          break;
      }
    });
  }
