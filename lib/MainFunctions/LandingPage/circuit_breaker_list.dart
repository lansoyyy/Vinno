...
import 'package:smart_cb_1/MainFunctions/LandingPage/circuit_breaker_tile.dart';
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          isEditMode ? "Edit Brackets" : "Business Location #",
                          style: TextStyle(
                            fontSize: 18,
                              ...
                              GestureDetector(
                                onTap: () {
                                  setState(() {
                                    ...
                                    // final toRemove =
                                    //     selectedBracketNames.toList()
                                    //       ..sort((a, b) => b.compareTo(a));
                                    // for (final index in toRemove) {
                                    //   bracketList.removeAt(index);
                                    // }
                                    // selectedBracketNames.clear();
                                    // isEditMode = false;
                                  });
...
class CustomClipPath extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    // First wave crest and trough
    path.quadraticBezierTo(
      w * 0.25, // control point x
      h - 180, // control point y (goes up)
      w * 0.5, // end point x
      h - 130, // end point y (down again)
    );

    // Second wave crest and trough
    path.quadraticBezierTo(
      w * 0.75,
      h - 80, // higher wave
      w,
    ...
    // Right edge → top edge → close path
    path.lineTo(w, 0);
    path.lineTo(0, 0);
    path.close();
