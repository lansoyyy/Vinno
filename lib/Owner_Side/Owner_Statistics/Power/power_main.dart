...
import 'package:smart_cb_1/Owner_Side/Owner_Statistics/Power/power_day.dart';
import 'package:smart_cb_1/Owner_Side/Owner_Statistics/Power/power_month.dart';
import 'package:smart_cb_1/Owner_Side/Owner_Statistics/Power/power_realtime.dart';
import 'package:smart_cb_1/Owner_Side/Owner_Statistics/Power/power_week.dart';
...
class PowerMain extends StatefulWidget {
  ...
  @override
  State<PowerMain> createState() => _PowerMainState();
}

class _PowerMainState extends State<PowerMain> {
  ...
  Future<void> _fetchBreakerData(String breakerName, String period) async {
    try {
      ...
      final data = await _statisticsService
          .getHistoricalData(breaker['scbId'], period, metric: 'power');
            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  ...
                  child: TabBarView(
                    children: [
                      PowerDay(dailyData: dayData[selectedBreaker] ?? {}),
                      PowerWeek(weeklyData: weekData[selectedBreaker] ?? {}),
                      PowerMonth(monthlyData: monthData[selectedBreaker] ?? {}),
                      PowerYear(yearlyData: yearData[selectedBreaker] ?? {}),
                    ],
                  ),
                ),
                Expanded(
