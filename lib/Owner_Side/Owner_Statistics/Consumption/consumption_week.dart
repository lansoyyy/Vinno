...
class ConsumptionWeek extends StatelessWidget {
  final Map<String, double> weeklyData; // 🔹 Data passed from parent

  const ConsumptionWeek({super.key, required this.weeklyData});
  ...
  Widget build(BuildContext context) {
    ...
    // Use all the data since we now have proper week ranges (Oct 7 - Nov 2, Nov 3-9...)
