...
class VoltageWeek extends StatelessWidget {
  final Map<String, double> weeklyData; // 🔹 Data passed from parent

  const VoltageWeek({super.key, required this.weeklyData});

  @override
  Widget build(BuildContext context) {
    print('VoltageWeek build called with data: $weeklyData');
    ...
    if (weeklyData.isEmpty) {
      print('Weekly data is empty, showing no data message');
      return Scaffold(
