...
class VoltageYear extends StatelessWidget {
  final Map<String, double> yearlyData; // 🔹 Data passed from parent

  const VoltageYear({super.key, required this.yearlyData});

  @override
  Widget build(BuildContext context) {
    print('VoltageYear build called with data: $yearlyData');
    ...
    if (yearlyData.isEmpty) {
      print('Yearly data is empty, showing no data message');
      return Scaffold(
