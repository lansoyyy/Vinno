...
class VoltageDay extends StatelessWidget {
  final Map<String, double> dailyData; // 🔹 Data passed from parent

  const VoltageDay({super.key, required this.dailyData});

  @override
  Widget build(BuildContext context) {
    print('VoltageDay build called with data: $dailyData');
    ...
    if (dailyData.isEmpty) {
      print('Daily data is empty, showing no data message');
      return Scaffold(
