...
import 'package:smart_cb_1/Owner_Side/Owner_Statistics/Temperature/temperature_day.dart';
import 'package:smart_cb_1/Owner_Side/Owner_Statistics/Temperature/temperature_month.dart';
import 'package:smart_cb_1/Owner_Side/Owner_Statistics/Temperature/temperature_realtime.dart';
import 'package:smart_cb_1/Owner_Side/Owner_Statistics/Temperature/temperature_week.dart';
import 'package:smart_cb_1/Owner_Side/Owner_Statistics/Temperature/temperature_year.dart';
...
class TemperatureMain extends StatefulWidget {
  const TemperatureMain({super.key});

  @override
  State<TemperatureMain> createState() => _TemperatureMainState();
}

class _TemperatureMainState extends State<TemperatureMain> {
  ...
  Future<void> _fetchBreakerData(String breakerName, String period) async {
    try {
      ...
      final data = await _statisticsService
          .getHistoricalData(breaker['scbId'], period, metric: 'temperature');
  ...
  Future<void> _fetchRealTimeData() async {
    try {
      ...
      // Use the service method which now reads from the temperature collection
      final data = await _statisticsService.getRealTimeData(
          breaker['scbId'], 'temperature');
      setState(() {
        realTimeValues = data;
      });
    } catch (e) {
            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  ...
                  child: TabBarView(
                    children: [
                      TemperatureDay(dailyData: dayData[selectedBreaker] ?? {}),
                      TemperatureWeek(
