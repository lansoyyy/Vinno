...
class TemperatureMonth extends StatelessWidget {
  final Map<String, double> monthlyData; // 🔹 Data passed from parent

  const TemperatureMonth({super.key, required this.monthlyData});
                ...
                bottomTitles: AxisTitles(
                  sideTitles: SideTitles(
                    ...
                    getTitlesWidget: (double value, TitleMeta meta) {
                      final day = monthlyData.keys.elementAt(value.toInt());
