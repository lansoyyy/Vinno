            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  ...
                  child: TabBarView(
                    children: [
                      PowerDay(dailyData: breakerData[selectedBreaker]!),
                      PowerWeek(weeklyData: breakerData[selectedBreaker]!),
                      PowerMonth(monthlyData: breakerData[selectedBreaker]!),
                      PowerYear(yearlyData: breakerData[selectedBreaker]!),
                    ],
                  ),
                ),
